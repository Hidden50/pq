...
app.recipeTable = {
	...
	Fire: {
		...
		good_nrec: ['GGr{byg}{by}', 'G{BRYS}rr{by}', 'G{RYS}rr{byg}', 'Mrrr{byg}', '{BYS}{YS}rrr'],
		very_good: ['BG{RYS}rr', 'RG{BYS}rr', 'GG{BRYS}r{by}', 'GG{RYS}r{byg}', 'GMrr{byg}', 'G{BRYS}{YS}rr', 'M{BYS}rrr'],
		very_good_nrec: ['RGGG{by}', 'GGMr{byg}', 'GG{BRYS}{RYS}r', 'GM{BRYS}rr', 'MMrrr'],
		special: ['RGGG{BRYS}', 'GGM{BRYS}r', 'GMMrr'],
		special_nrec: ['RGGGM', 'GGMMr'],
	},
	Electric: {
		basic: [],
		good: ['YYry{br}'],
